...
`v2.0.0-rc1` — предварительный PS17-порт без заявленного аппаратного теста. Прошивайте только файл, реально опубликованный вместе с `SHA256SUMS.txt` в одном GitHub Release; имена ниже не означают, что бинарник уже выпущен.
...
- На странице версии виден маркер нужной платы: `T096 SmartUI 2.0.0-rc1`, `T114 SmartUI 2.0.0-rc1` или `ProMicro SmartUI 2.0.0-rc1`.
