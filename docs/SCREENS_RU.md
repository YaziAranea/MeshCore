...
Изображения ниже — пиксельная симуляция интерфейса SmartUI PS17. Первые три платы сохраняют контракт `v2.0.0-rc1`; V4.3 и Wireless Paper относятся к `2.1.0-dev`. Это не фотографии и не подтверждение электрической проверки.
...
Дополнительные `2.1.0-dev` матрицы: V4.3 OLED `20/20`, Wireless Paper `160/160`, без выходов за framebuffer и непредусмотренных пересечений. На e-paper 88 обрезанных концов декоративных линий Wood являются намеренным clipping, а не текстовыми потерями.
