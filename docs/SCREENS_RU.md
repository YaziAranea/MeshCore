...
Изображения ниже — пиксельная симуляция интерфейса SmartUI PS17. Первые три платы сохраняют основной контракт `v2.0.0-rc1`; V4.3 и Wireless Paper добавлены в линии 2.1. В `v2.1.0-beta.1` часы получили компактный аптайм, добавлен подтверждаемый часовой пояс, а недоверенное RTC больше не изображается как синхронизированное. Это не фотографии и не подтверждение электрической проверки.
