...
Изображения ниже — пиксельная симуляция текущего интерфейса SmartUI PS17. Они задают визуальный контракт `v2.0.0-rc1`, но не являются фотографиями и сами по себе не подтверждают работу прошивки на платах.
