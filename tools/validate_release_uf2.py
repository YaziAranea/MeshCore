...
EXPECTED = {
    "T096_FEM_SmartUI_2.1.0-dev.2.uf2": b"T096 SmartUI 2.1.0-dev.2",
    "T114_SmartUI_2.1.0-dev.2.uf2": b"T114 SmartUI 2.1.0-dev.2",
    "ProMicro_RA62_SmartUI_2.1.0-dev.2.uf2": b"ProMicro SmartUI 2.1.0-dev.2",
}
