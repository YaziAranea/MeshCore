...
Текущий публичный GitHub Release показывает маркер `SmartUI 2.1.0-dev.1`. Hotfix исправляет первое BLE-сопряжение на всех пяти платах и заменяет предыдущий `v2.1.0-dev`, но не заменяет RC-линию `v2.0.0-rc1`.
