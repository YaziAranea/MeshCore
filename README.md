...
Read-only CI собирает шесть релизных конфигураций, проверяет UF2/BIN, native-тесты и точные модели дисплеев. Дополнительно собираются четыре представителя общих display-драйверов — V3, RAK4631, Xiao S3 WIO и Heltec T1; это контроль совместимости, не добавление этих плат в Release.
