...
> Имена файлов прежние: проверяйте свежие SHA256 и ревизию `FS2` в V3-манифесте.
...
- Исключение — **V3 freshInstall-merged FS2**: его пустое SPIFFS перезаписывает identity/настройки даже без Erase. Для сохранения данных используйте update. V4.3/Wireless Paper в FS2 не пересобраны; после Erase их пустое хранилище также может вызвать `STORAGE ERROR`. V3-файлы им не подходят.
